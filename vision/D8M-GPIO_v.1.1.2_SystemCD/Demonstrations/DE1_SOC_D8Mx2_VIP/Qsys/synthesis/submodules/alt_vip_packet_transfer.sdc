...
set_net_delay -from [get_pins -compatibility_mode {*packet_transfer*write_proc_instance|*mem_ctr_crosser|din_reg*}] -to [get_keepers {*packet_transfer*write_proc_instance|*mem_ctr_crosser|delay_line[*]*}] -min 0
...
set_net_delay -from [get_pins -compatibility_mode {*packet_transfer*write_proc_instance|*unload_ack*}] -to [get_keepers {*packet_transfer*write_proc_instance|*unload_ack_crosser|delay_line[*]*}] -min 0
...
set_net_delay -from [get_pins -compatibility_mode {*packet_transfer*write_proc_instance|*unload_req*}] -to [get_keepers {*packet_transfer*write_proc_instance|*unload_req_crosser|delay_line[*]*}] -min 0
...
set_net_delay -min -from [get_keepers {*packet_transfer*write_proc_instance|*unload_buffered*}] -to [get_keepers {*packet_transfer*write_proc_instance|*_mm_output*}] 0
...
set_net_delay -from [get_pins -compatibility_mode {*packet_transfer*read_proc_instance|*read_syn_buf*}] -to [get_keepers {*packet_transfer*read_proc_instance|*read_syn_crosser|delay_line[*]*}] -min 0
...
set_net_delay -from [get_pins -compatibility_mode {*packet_transfer*read_proc_instance|*read_ack_buf*}] -to [get_keepers {*packet_transfer*read_proc_instance|*read_ack_crosser|delay_line[*]*}] -min 0
...
set_max_delay -from [get_keepers {*packet_transfer*read_proc_instance|*current_ctxt_burst_size*
                                  ...
                                  }] -to [get_keepers *packet_transfer*read_proc_instance\|*mm_msg_queue*scfifo*porta_datain*]  100
...
set_net_delay -max -from [get_keepers {*packet_transfer*read_proc_instance|*current_ctxt_burst_size*
                                       *packet_transfer*read_proc_instance|*ctxt_expecting_valid_ptr*
                                      }] -to [get_keepers *packet_transfer*read_proc_instance\|*mm_msg_queue*scfifo*porta_datain*]  2
                                  
set_net_delay -min -from [get_keepers {*packet_transfer*read_proc_instance|*current_ctxt_burst_size*
                                       *packet_transfer*read_proc_instance|*ctxt_expecting_valid_ptr*
                                      }] -to [get_keepers *packet_transfer*read_proc_instance\|*mm_msg_queue*scfifo*porta_datain*]  0
...
set_net_delay -min -from [get_keepers {*packet_transfer*read_proc_instance|*csel_target_addr*
                                       *packet_transfer*read_proc_instance|*context_target_addr*
                                       *packet_transfer*read_proc_instance|*ctxt_target_addr*
                                       *packet_transfer*read_proc_instance|*period_targer_addr_start*
                                       *packet_transfer*read_proc_instance|*current_ctxt_id*
                                      }] -to [get_keepers {*read_proc_instance|*mm_target_addr*}]    0
...
set_net_delay -min -from [get_keepers {*packet_transfer*read_proc_instance|*current_ctxt_burst_size*}] -to [get_keepers {*read_proc_instance|*mm_burst_size*}]   0
