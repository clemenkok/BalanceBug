	Qsys u0 (
		...
		.camera0_refclk_clk                        (<connected-to-camera0_refclk_clk>),                        //                   camera0_refclk.clk
		.camera1_refclk_clk                        (<connected-to-camera1_refclk_clk>),                        //                   camera1_refclk.clk
		.clk_clk                                   (<connected-to-clk_clk>),                                   //                              clk.clk
		.clk_sdram_clk                             (<connected-to-clk_sdram_clk>),                             //                        clk_sdram.clk
		.clk_vga_clk                               (<connected-to-clk_vga_clk>),                               //                          clk_vga.clk
		.i2c_opencores_camera_1_export_scl_pad_io  (<connected-to-i2c_opencores_camera_1_export_scl_pad_io>),  //    i2c_opencores_camera_1_export.scl_pad_io
		.i2c_opencores_camera_1_export_sda_pad_io  (<connected-to-i2c_opencores_camera_1_export_sda_pad_io>),  //                                 .sda_pad_io
		...
		.i2c_opencores_mipi_1_export_scl_pad_io    (<connected-to-i2c_opencores_mipi_1_export_scl_pad_io>),    //      i2c_opencores_mipi_1_export.scl_pad_io
		.i2c_opencores_mipi_1_export_sda_pad_io    (<connected-to-i2c_opencores_mipi_1_export_sda_pad_io>),    //                                 .sda_pad_io
		...
		.terasic_auto_focus_1_conduit_vcm_i2c_sda  (<connected-to-terasic_auto_focus_1_conduit_vcm_i2c_sda>),  //     terasic_auto_focus_1_conduit.vcm_i2c_sda
		.terasic_auto_focus_1_conduit_clk50        (<connected-to-terasic_auto_focus_1_conduit_clk50>),        //                                 .clk50
		.terasic_auto_focus_1_conduit_vcm_i2c_scl  (<connected-to-terasic_auto_focus_1_conduit_vcm_i2c_scl>),  //                                 .vcm_i2c_scl
		...
		.terasic_camera_1_conduit_end_D            (<connected-to-terasic_camera_1_conduit_end_D>),            //     terasic_camera_1_conduit_end.D
		.terasic_camera_1_conduit_end_FVAL         (<connected-to-terasic_camera_1_conduit_end_FVAL>),         //                                 .FVAL
		.terasic_camera_1_conduit_end_LVAL         (<connected-to-terasic_camera_1_conduit_end_LVAL>),         //                                 .LVAL
		.terasic_camera_1_conduit_end_PIXCLK       (<connected-to-terasic_camera_1_conduit_end_PIXCLK>)        //                                 .PIXCLK
	);
