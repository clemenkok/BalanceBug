...
alias com {
  ...
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/Qsys_mm_interconnect_1_rsp_mux.sv"                           -work rsp_mux                                   
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/Qsys_mm_interconnect_1_rsp_demux.sv"                         -work rsp_demux                                 
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                                 -work cmd_mux                                   
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/Qsys_mm_interconnect_1_cmd_mux.sv"                           -work cmd_mux                                   
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/Qsys_mm_interconnect_1_cmd_demux.sv"                         -work cmd_demux                                 
  ...
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/Qsys_mm_interconnect_1_router_002.sv"                        -work router_002                                
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/Qsys_mm_interconnect_1_router.sv"                            -work router                                    
  ...
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/Qsys_mm_interconnect_0_rsp_demux_005.sv"                     -work rsp_demux_005                             
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/Qsys_mm_interconnect_0_rsp_demux_004.sv"                     -work rsp_demux_004                             
  ...
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/Qsys_mm_interconnect_0_cmd_mux_004.sv"                       -work cmd_mux_004                               
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                                 -work cmd_mux                                   
  ...
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_traffic_limiter.sv"                            -work nios2_gen2_data_master_limiter            
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_reorder_memory.sv"                             -work nios2_gen2_data_master_limiter            
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_avalon_sc_fifo.v"                                     -work nios2_gen2_data_master_limiter            
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_avalon_st_pipeline_base.v"                            -work nios2_gen2_data_master_limiter            
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/Qsys_mm_interconnect_0_router_006.sv"                        -work router_006                                
  ...
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_master_agent.sv"                               -work nios2_gen2_data_master_agent              
  ...
  eval  vlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_master_translator.sv"                          -work nios2_gen2_data_master_translator         
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/Qsys_nios2_gen2_cpu.vo"                                      -work cpu                                       
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/Qsys_nios2_gen2_cpu_debug_slave_sysclk.v"                    -work cpu                                       
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/Qsys_nios2_gen2_cpu_debug_slave_tck.v"                       -work cpu                                       
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/Qsys_nios2_gen2_cpu_debug_slave_wrapper.v"                   -work cpu                                       
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/Qsys_nios2_gen2_cpu_mult_cell.v"                             -work cpu                                       
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/Qsys_nios2_gen2_cpu_test_bench.v"                            -work cpu                                       
  ...
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/Qsys_mm_interconnect_1.v"                                    -work mm_interconnect_1                         
  ...
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/Qsys_sysid_qsys.vo"                                          -work sysid_qsys                                
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/Qsys_sw.v"                                                   -work sw                                        
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/Qsys_sdram.v"                                                -work sdram                                     
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/Qsys_sdram_test_component.v"                                 -work sdram                                     
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/Qsys_onchip_memory2_0.v"                                     -work onchip_memory2_0                          
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/Qsys_nios2_gen2.v"                                           -work nios2_gen2                                
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/Qsys_mipi_pwdn_n.v"                                          -work mipi_pwdn_n                               
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/Qsys_led.v"                                                  -work led                                       
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/Qsys_key.v"                                                  -work key                                       
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/Qsys_jtag_uart.v"                                            -work jtag_uart                                 
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/i2c_opencores.v"                                             -work i2c_opencores_camera                      
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/i2c_master_top.v"                                            -work i2c_opencores_camera                      
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/i2c_master_defines.v"                                        -work i2c_opencores_camera                      
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/i2c_master_byte_ctrl.v"                                      -work i2c_opencores_camera                      
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/i2c_master_bit_ctrl.v"                                       -work i2c_opencores_camera                      
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/timescale.v"                                                 -work i2c_opencores_camera                      
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/Qsys_altpll_0.vo"                                            -work altpll_0                                  
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/Qsys_alt_vip_vfb_0.vo"                                       -work alt_vip_vfb_0                             
  ...
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/TERASIC_CAMERA.v"                                            -work TERASIC_CAMERA_0                          
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/CAMERA_RGB.v"                                                -work TERASIC_CAMERA_0                          
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/CAMERA_Bayer.v"                                              -work TERASIC_CAMERA_0                          
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/Bayer2RGB.v"                                                 -work TERASIC_CAMERA_0                          
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/Bayer_LineBuffer.v"                                          -work TERASIC_CAMERA_0                          
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/rgb_fifo.v"                                                  -work TERASIC_CAMERA_0                          
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/add2.v"                                                      -work TERASIC_CAMERA_0                          
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/add4.v"                                                      -work TERASIC_CAMERA_0                          
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/TERASIC_AUTO_FOCUS.v"                                        -work TERASIC_AUTO_FOCUS_0                      
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/F_VCM.v"                                                     -work TERASIC_AUTO_FOCUS_0                      
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/I2C_VCM_Config.v"                                            -work TERASIC_AUTO_FOCUS_0                      
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/I2C_VCM_Controller.v"                                        -work TERASIC_AUTO_FOCUS_0                      
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/VCM_CTRL_P.v"                                                -work TERASIC_AUTO_FOCUS_0                      
...
alias elab_debug {
  ...
  eval vsim -novopt -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L work_lib -L error_adapter_0 -L rsp_mux -L rsp_demux -L cmd_mux -L cmd_demux -L sdram_s1_burst_adapter -L router_002 -L router -L avalon_st_adapter -L crosser -L rsp_mux_001 -L rsp_demux_005 -L rsp_demux_004 -L cmd_mux_004 -L cmd_demux_001 -L nios2_gen2_data_master_limiter -L router_006 -L router_001 -L jtag_uart_avalon_jtag_slave_agent_rsp_fifo -L jtag_uart_avalon_jtag_slave_agent -L nios2_gen2_data_master_agent -L jtag_uart_avalon_jtag_slave_translator -L nios2_gen2_data_master_translator -L cpu -L rst_controller -L irq_mapper -L mm_interconnect_1 -L mm_interconnect_0 -L timer -L sysid_qsys -L sw -L sdram -L onchip_memory2_0 -L nios2_gen2 -L mipi_pwdn_n -L led -L key -L jtag_uart -L i2c_opencores_camera -L altpll_0 -L alt_vip_vfb_0 -L alt_vip_itc_0 -L TERASIC_CAMERA_0 -L TERASIC_AUTO_FOCUS_0 -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cycloneive_ver $TOP_LEVEL_NAME
}
