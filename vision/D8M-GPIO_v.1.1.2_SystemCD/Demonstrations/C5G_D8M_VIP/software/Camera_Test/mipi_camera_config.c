...
//	     {0x6c,0x380b, 0xE0}, // Y output size L
	     ...
	     // 1920x1080
	     {0x6c,0x3808, 0x07}, // X output size H
	     {0x6c,0x3809, 0x80}, // X output size L
	     {0x6c,0x380a, 0x04}, // Y output size H
	     {0x6c,0x380b, 0x38}, // Y output size L


	     // 15 fps (combined with pll settings)
	     {0x6c,0x380c, 0x1C}, // HTS H
	     {0x6c,0x380d, 0xB0}, // HTS L
	     {0x6c,0x380e, 0x05}, // VTS H
	     {0x6c,0x380f, 0x50}, // VTS L
	     ...
	     {0x6c,0x3821, 0x00}, // hsync_en_o, fst_vbin, mirror on
