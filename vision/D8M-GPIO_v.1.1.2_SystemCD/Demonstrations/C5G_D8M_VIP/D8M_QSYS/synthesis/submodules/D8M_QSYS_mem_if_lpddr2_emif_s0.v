// D8M_QSYS_mem_if_lpddr2_emif_s0.v
...
`timescale 1 ps / 1 ps
module D8M_QSYS_mem_if_lpddr2_emif_s0 (
		...
		output wire [3:0]   scc_data,                    //              scc.scc_data
	...
	rw_manager_lpddr2 #(
		...
		.HCX_COMPAT_MODE                      (0),
		.DEVICE_FAMILY                        ("CYCLONEV"),
		.AC_ROM_INIT_FILE_NAME                ("D8M_QSYS_mem_if_lpddr2_emif_s0_AC_ROM.hex"),
		.INST_ROM_INIT_FILE_NAME              ("D8M_QSYS_mem_if_lpddr2_emif_s0_inst_ROM.hex"),
	...
	altera_mem_if_sequencer_mem_no_ifdef_params #(
		...
		.AVL_SYMBOL_WIDTH (8),
		.MEM_SIZE         (24576),
		.INIT_FILE        ("D8M_QSYS_mem_if_lpddr2_emif_s0_sequencer_mem.hex"),
		.RAM_BLOCK_TYPE   ("AUTO")
	) sequencer_mem (
	...
	D8M_QSYS_mem_if_lpddr2_emif_s0_mm_interconnect_0 mm_interconnect_0 (
	...
	D8M_QSYS_mem_if_lpddr2_emif_s0_irq_mapper irq_mapper (
		.clk        (avl_clk),                       //       clk.clk
