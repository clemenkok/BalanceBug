...
lappend arg_list "--component-param=SEQ_ROM=D8M_QSYS_mem_if_lpddr2_emif_s0_sequencer_mem.hex"
lappend arg_list "--component-param=RAM_BLOCK_TYPE=AUTO"
lappend arg_list "--component-param=AC_ROM_INIT_FILE_NAME=D8M_QSYS_mem_if_lpddr2_emif_s0_AC_ROM.hex"
lappend arg_list "--component-param=INST_ROM_INIT_FILE_NAME=D8M_QSYS_mem_if_lpddr2_emif_s0_inst_ROM.hex"
...
lappend arg_list "--component-param=SCC_DATA_WIDTH=4"
...
lappend arg_list "--output-name=D8M_QSYS_mem_if_lpddr2_emif_s0"
lappend arg_list "--system-info=DEVICE_FAMILY=CYCLONEV"
lappend arg_list "--report-file=sopcinfo:D8M_QSYS_mem_if_lpddr2_emif_s0.sopcinfo"
lappend arg_list "--report-file=txt:D8M_QSYS_mem_if_lpddr2_emif_s0_seq_ipd_report.txt"
lappend arg_list "--file-set=QUARTUS_SYNTH"
catch { eval [concat [list exec "J:/altera/15.0.0.145/quartus/sopc_builder/bin/ip-generate" --component-name=qsys_sequencer_110] $arg_list] } temp
puts $temp
