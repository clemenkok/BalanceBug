...
module Qsys_alt_vip_cl_vfb_0 #(
		...
		parameter CORRECT_INVALID_FIELDS       = 0,
		...
		output wire [4:0]  mem_master_wr_burstcount,    //              .burstcount
		input  wire        mem_master_wr_waitrequest,   //              .waitrequest
		output wire        mem_master_wr_write,         //              .write
		output wire [63:0] mem_master_wr_writedata,     //              .writedata
		output wire [7:0]  mem_master_wr_byteenable,    //              .byteenable
		output wire [31:0] mem_master_rd_address,       // mem_master_rd.address
		output wire [4:0]  mem_master_rd_burstcount,    //              .burstcount
		input  wire        mem_master_rd_waitrequest,   //              .waitrequest
		output wire        mem_master_rd_read,          //              .read
		input  wire [63:0] mem_master_rd_readdata,      //              .readdata
	...
	generate
		...
		begin
			...
			instantiated_with_wrong_parameters_error_see_comment_above
					correct_invalid_fields_check ( .error(1'b1) );
		end
	...
	alt_vip_packet_transfer #(
		...
		.CONTEXT_BUFFER_RATIO_WRITE        (32),
		.BURST_TARGET_WRITE                (16),
		.MAX_PACKET_SIZE_WRITE             (640),
	...
	alt_vip_packet_transfer #(
		...
		.READ_ENABLE                       (1),
		.MAX_CONTEXT_NUMBER_READ           (1),
		.CONTEXT_BUFFER_RATIO_READ         (32),
		.BURST_TARGET_READ                 (16),
		.MAX_PACKET_SIZE_READ              (640),
